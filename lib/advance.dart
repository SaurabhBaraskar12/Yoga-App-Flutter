          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Pose Name: Eka pada Rajakapotasana',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500,
                  color: Colors.teal),
                ),
                Image.asset('adv1.jpg'),
                SizedBox(height: 10),
                Text(
                  'Pose Description:',
                ...
                SizedBox(height: 10),
                Text(
                  'Eka pada rajakapotasana, also known as alternate nostril breathing, is a yogic breathing technique where you inhale through one nostril while closing the other, and then exhale through the opposite nostril. It helps to balance the flow of energy in the body, reduce stress, and promote relaxation.',
                ...
                SizedBox(height: 10),
                Text(
                  '1. Eka pada rajakapotsana helps reduce stress, anxiety, and promotes relaxation.\n'
                ...
                Text(
                  'Pose Name: Eka Pada Bakasana',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500,
                  color: Colors.teal),
                ),
                Image.asset('adv3.jpg'),
                SizedBox(height: 10),
                Text(
                  'Pose Description:',
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
